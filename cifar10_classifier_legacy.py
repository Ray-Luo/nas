...
from blocks_legacy import FBNetV2BasicSearchBlock
from tqdm import tqdm
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.pool(torch.relu(self.bn2(self.conv2(x)))) # 150, 16, 16 --> 150, 16, 16
        x = self.pool(torch.relu(self.bn3(self.conv3(x)))) # 150, 16, 16 --> 300, 16, 16
